...
export default function CourseCard({ img, title, users, rating, revenue, published, onTitleClick, onEditClick }) {
    return (
        <div className="bg-white ml-5 rounded-xl mt-5 h-20 flex w-161 border border-gray-200" >
            ...
            <div className="flex gap-2 mr-2">
                ...
                <div className="rounded-lg bg-black text-white h-8.5 w-17 text-md pl-2 pt-1 mt-6.5 ml-2 flex cursor-pointer" onClick={onEditClick}>
                    <svg
